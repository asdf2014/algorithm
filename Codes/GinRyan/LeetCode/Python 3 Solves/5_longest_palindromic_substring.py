                ...
                for n in range(naborspace +1):
                    ...
                    if left >= 0 and right < total:
                        ...
                        if sLeft!=sRight:
                            ...
                            break
                        print("----比对到相同对: " + s[left] + s[right] + " 范围: " + s[left:right+1])
                        diff = right + 1 - left
                        if diff >= maxPali:
                            maxPali = diff
                            maxLeft  = left
                            maxRight = right + 1
                            print("------更新最大子回文串: " + s[maxLeft:maxRight] + " 范围： " + str(maxLeft) + "," + str(maxRight))
